...
## Project Structure
    ...
    ├── testapiautosetting_126351  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_126351`
...
2. Clone this repo and `cd testapiautosetting_126351`
